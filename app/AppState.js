...
class ObservableAppState extends EventEmitter {
  ...
  snacks = [
    ...
    new Snack({ name: 'Wheat Grain', price: 25.45, imgUrl: 'https://images.unsplash.com/photo-1555064837-3c7ae70f81be?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8M3x8d2hlYXQlMjBncmFpbnxlbnwwfHwwfHx8MA%3D%3D&auto=format&fit=crop&w=500&q=60' })
  ]
  money = 20
  // !SECTION
